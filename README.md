...
failts to run correctly on windows 10 command prompt or powershell, partially works on terminal emulators such as msys2 though results are not that good.
